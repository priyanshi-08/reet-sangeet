...
const ContactUs = () => {
  const whatsappLink =
    "https://wa.me/917303747778?text=Hi%20Reet%20Sangeet!%20I%20have%20a%20query.";
    ...
    <div className="min-h-screen bg-soft-pearl text-deep-navy py-12 px-4 md:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-extrabold text-center mb-12">
          Connect With <span className="text-soothing-teal">Us</span>
        </h1>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-green-50 p-8 rounded-2xl border border-green-200 flex flex-col items-center text-center">
              ...
              <p className="text-deep-navy/70 mb-6">
                Need a quick response? Message us directly for immediate
                assistance.
              </p>
              <a
                href={whatsappLink}
