          ...
          <div className="flex gap-6">
            ...
            <div className="flex flex-col items-center">
              <div className="p-2 bg-white rounded-xl shadow-md border-2 border-transparent hover:border-soothing-teal transition-colors">
                <QRCode value="https://facebook.com" size={80} fgColor="#292F36" />
              </div>
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="mt-3 flex items-center gap-2 text-soft-pearl/80 hover:text-soothing-teal transition-colors">
